...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_AITER_FUSED_ALLREDUCE_RMSNORM: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use aiter fused allreduce rmsnorm kernel
    # By default is disabled.
    "VLLM_ROCM_USE_AITER_FUSED_ALLREDUCE_RMSNORM": lambda: (
        os.getenv("VLLM_ROCM_USE_AITER_FUSED_ALLREDUCE_RMSNORM", "False").lower() in ("true", "1")
    ),    
...
def compute_hash() -> str:
    ...
    environment_variables_to_hash = [
        ...
        "VLLM_ROCM_USE_AITER_FUSED_ALLREDUCE_RMSNORM",
